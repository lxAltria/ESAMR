...
namespace MDR {
    ...
    public:
        GroupedBPEncoder(){
            ...
            static_assert(std::is_unsigned<T_stream>::value, "GroupedBPBlockEncoder: streams streams must be unsigned integers.");
            static_assert(std::is_integral<T_stream>::value, "GroupedBPBlockEncoder: streams streams must be unsigned integers.");
        }
