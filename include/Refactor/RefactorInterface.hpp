...
namespace MDR {
    namespace concepts {
        ...
        public:
            ...
            virtual void refactor(T const * data_, const std::vector<uint32_t>& dims, uint8_t target_level, uint8_t num_bitplanes, std::vector<uint32_t> block_sizes=std::vector<uint32_t>()) = 0;
